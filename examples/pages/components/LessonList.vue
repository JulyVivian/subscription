  ...
  <div class="lesson-big-box">
    ...
    <modal :btns="btntext1" :showPop="showPop1" @click="onClickModal" class="top-up">
      ...
      <div slot="content" class="popup-bd">
        <div>
          <input v-focus="focused1" @keyup="oneKeyUp" maxlength="1" type="tel"/>
          <input v-focus="focused2" @keyup="twoKeyUp" maxlength="1" type="tel"/>
          <input v-focus="focused3" @keyup="threeKeyUp" maxlength="1" type="tel"/>
          <input v-focus="focused4" @keyup="fourKeyUp" maxlength="1" type="tel"/>
        </div>
      </div>
    </modal>
